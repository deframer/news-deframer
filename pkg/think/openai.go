...
var openAISchemaDefinition = jsonschema.Definition{
	...
	Properties: map[string]jsonschema.Definition{
		...
		"framing_score":                 {Type: jsonschema.Number},
		"framing_reason":                {Type: jsonschema.String},
		"clickbait_score":               {Type: jsonschema.Number},
		"clickbait_reason":              {Type: jsonschema.String},
		"persuasive_score":              {Type: jsonschema.Number},
		"persuasive_reason":             {Type: jsonschema.String},
		"hyper_stimulus_score":          {Type: jsonschema.Number},
		"hyper_stimulus_reason":         {Type: jsonschema.String},
		"speculative_score":             {Type: jsonschema.Number},
	...
	Required: []string{
		...
		"framing_score", "framing_reason",
		"clickbait_score", "clickbait_reason",
		"persuasive_score", "persuasive_reason",
		"hyper_stimulus_score", "hyper_stimulus_reason",
		"speculative_score", "speculative_reason",
		"overall_reason",
	},
