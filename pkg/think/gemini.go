...
var geminiSchema = &genai.Schema{
	...
	Properties: map[string]*genai.Schema{
		...
		"framing_score":                 {Type: genai.TypeNumber},
		"framing_reason":                {Type: genai.TypeString},
		"clickbait_score":               {Type: genai.TypeNumber},
		"clickbait_reason":              {Type: genai.TypeString},
		"persuasive_score":              {Type: genai.TypeNumber},
		"persuasive_reason":             {Type: genai.TypeString},
		"hyper_stimulus_score":          {Type: genai.TypeNumber},
		"hyper_stimulus_reason":         {Type: genai.TypeString},
		"speculative_score":             {Type: genai.TypeNumber},
