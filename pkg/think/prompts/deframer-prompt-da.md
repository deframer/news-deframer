...
17. **`category`** (String): En journalistisk hovedkategori. Skal være strengt en af: `politik`, `verden`, `erhverv`, `sport`, `kultur`, `teknologi`, `sundhed`, `finans`, `videnskab`, `miljo`, `rejse`, `livsstil`, `spil`, `historie`, `mening`, `andet`.
