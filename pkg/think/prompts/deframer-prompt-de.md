...
5.  **`framing`** (Float, 0.0 - 1.0): Wie stark ist der Text ideologisch gefärbt oder meinungsgetrieben? (0.0 = rein faktisch, 1.0 = Propaganda/starker Bias).
...
17. **`category`** (String): Eine journalistische Hauptkategorie. Muss strikt eine von: `politik`, `welt`, `wirtschaft`, `sport`, `kultur`, `technologie`, `gesundheit`, `finanzen`, `wissenschaft`, `umwelt`, `reisen`, `lifestyle`, `spiele`, `geschichte`, `meinung`, `sonstiges` sein.
