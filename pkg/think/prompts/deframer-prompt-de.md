...
17. **`category`** (String): Eine journalistische Hauptkategorie. Muss strikt eine von: `politik`, `welt`, `wirtschaft`, `sport`, `kultur`, `technologie`, `gesundheit`, `finanzen`, `wissenschaft`, `umwelt`, `reisen`, `lifestyle`, `sonstiges` sein.
