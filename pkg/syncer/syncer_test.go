...
func TestExtractAuthors(t *testing.T) {
	...
	t.Run("extracts from dc creator", func(t *testing.T) {
		...
		assert.Equal(t, database.StringArray{"John Doe"}, s.extractAndNormalizeAuthors(item))
	})
	...
	t.Run("splits combined authors like sql", func(t *testing.T) {
		...
		assert.Equal(t, database.StringArray{"Alice", "Bob", "Carol", "Dora"}, s.extractAndNormalizeAuthors(item))
	})
	...
	t.Run("removes publisher suffix", func(t *testing.T) {
		...
		assert.Equal(t, database.StringArray{"Jane Doe"}, s.extractAndNormalizeAuthors(item))
	})
	...
	t.Run("prefers parsed gofeed authors", func(t *testing.T) {
		...
		assert.Equal(t, database.StringArray{"Parsed Author"}, s.extractAndNormalizeAuthors(item))
	})
}
