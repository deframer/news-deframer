...
type mockRepo struct {
	...
	getTopTrendByDomainFunc  func(domain string, language string, date string, days int) ([]database.TrendMetric, error)
	getContextByDomainFunc   func(term string, domain string, language string, date string, days int) ([]database.TrendContext, error)
	getLifecycleByDomainFunc func(term string, domain string, language string, date string, days int) ([]database.Lifecycle, error)
	getDomainComparisonFunc  func(domainA string, domainB string, language string, date string, days int, utilityThreshold float64, outlierRatioThreshold float64, limit int) ([]database.DomainComparison, error)
	getArticlesByTrendFunc   func(term string, domain string, date string, days int) ([]database.AnalyzedArticle, error)
}
...
func (m *mockRepo) GetContextByDomain(term string, domain string, language string, date string, days int) ([]database.TrendContext, error) {
	if m.getContextByDomainFunc != nil {
		return m.getContextByDomainFunc(term, domain, language, date, days)
	}
	return nil, nil
}
...
func (m *mockRepo) GetLifecycleByDomain(term string, domain string, language string, date string, days int) ([]database.Lifecycle, error) {
	if m.getLifecycleByDomainFunc != nil {
		return m.getLifecycleByDomainFunc(term, domain, language, date, days)
	}
	return nil, nil
}
...
func (m *mockRepo) GetDomainComparison(domainA string, domainB string, language string, date string, days int, utilityThreshold float64, outlierRatioThreshold float64, limit int) ([]database.DomainComparison, error) {
	if m.getDomainComparisonFunc != nil {
		return m.getDomainComparisonFunc(domainA, domainB, language, date, days, utilityThreshold, outlierRatioThreshold, limit)
	}
	return nil, nil
}
...
func (m *mockRepo) GetArticlesByTrend(term string, domain string, date string, days int) ([]database.AnalyzedArticle, error) {
	if m.getArticlesByTrendFunc != nil {
		return m.getArticlesByTrendFunc(term, domain, date, days)
	}
	return nil, nil
}
