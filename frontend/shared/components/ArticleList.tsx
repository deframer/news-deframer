...
import { AnalyzedArticle, DomainEntry, NewsDeframerApi } from '@frontend-shared/ndf-api-interfaces';
...
export const ArticleList = ({ term, domain, date, days, titleOverride, hideTitle = false, api }: ArticleListProps) => {
  ...
  useEffect(() => {
    const fetchArticles = async () => {
      ...
      try {
        ...
        const result = await api.getArticlesByTrend(domain.domain, term, date, days, offset, limit);
    ...
    fetchArticles();
  }, [api, term, domain, date, days, currentPage]);
