...
export const TabTrend = ({ domain, availableDomains, searchEngineUrl, api }: { domain: DomainEntry; availableDomains: DomainEntry[]; searchEngineUrl: string; api: NewsDeframerApi }) => {
  ...
  return (
    <div className="trend-container">
      ...
      <div className="trend-content">
        {viewMode === 'cloud' && <TrendTagCloud api={api} domain={domain} days={currentDays} searchEngineUrl={searchEngineUrl} activeTab={detailTab} setActiveTab={setDetailTab} />}
        ...
        {viewMode === 'lifecycle' && <TrendSearch api={api} domain={domain} days={currentDays} activeTab={detailTab} setActiveTab={setDetailTab} />}
