...
const resources = {
  en: {
    translation: {
      ...
      mobile: {
        dashboard_title: 'News Deframer', about_title: 'About', about_body: 'News Deframer', menu_dashboard: 'Dashboard', menu_settings: 'Settings', menu_about: 'About', no_domains: 'No domains available.', pick_domain: 'Choose a domain to open a portal.', missing_config: 'Add your server settings to continue.', portal_title: 'Portal', trends: 'Trends', trend_mining: 'Trend Mining', trend_mining_placeholder: 'Trend mining will land here next. For now, use the Articles tab to browse the current portal feed.', trends_tag_cloud_title: 'Tag Cloud', trends_tag_cloud_body: 'Tag cloud is planned next. This panel is reserved for the first trends implementation.', trends_selected_range: 'Selected range: {{range}}', trends_compare_title: 'Compare', trends_compare_body: 'Compare view placeholder. Domain comparison will be added in the next step.', trends_search_title: 'Search', trends_search_body: 'Search placeholder. Trend search and drill-down will be added next.', portal_empty_title: 'No articles yet', portal_empty_body: 'This domain is configured, but the backend did not return any portal articles.', portal_load_error_title: 'Could not load articles', portal_load_error: 'The mobile app could not load this portal right now. Please try again.', retry: 'Retry', open_project: 'News Deframer on GitHub', ok: 'OK',
      },
    },
  },
  de: {
    translation: {
      ...
      mobile: {
        dashboard_title: 'News Deframer', about_title: 'Über', about_body: 'News Deframer', menu_dashboard: 'Dashboard', menu_settings: 'Einstellungen', menu_about: 'Über', no_domains: 'Keine Domains verfügbar.', pick_domain: 'Wählen Sie eine Domain, um ein Portal zu öffnen.', missing_config: 'Fügen Sie Ihre Server-Einstellungen hinzu, um fortzufahren.', portal_title: 'Portal', trends: 'Trends', trend_mining: 'Trend Mining', trend_mining_placeholder: 'Trend Mining erscheint hier als Nächstes. Verwenden Sie vorerst den Tab Artikel, um den aktuellen Portal-Feed zu durchsuchen.', trends_tag_cloud_title: 'Tag Cloud', trends_tag_cloud_body: 'Tag Cloud folgt als nächster Schritt. Dieses Panel ist für die erste Trends-Umsetzung reserviert.', trends_selected_range: 'Ausgewählter Zeitraum: {{range}}', trends_compare_title: 'Vergleich', trends_compare_body: 'Vergleichsansicht als Platzhalter. Domain-Vergleich folgt im nächsten Schritt.', trends_search_title: 'Suche', trends_search_body: 'Suchansicht als Platzhalter. Trendsuche und Drill-down folgen als Nächstes.', portal_empty_title: 'Noch keine Artikel', portal_empty_body: 'Diese Domain ist konfiguriert, aber das Backend hat keine Portal-Artikel zurückgegeben.', portal_load_error_title: 'Artikel konnten nicht geladen werden', portal_load_error: 'Die Mobile-App konnte dieses Portal gerade nicht laden. Bitte versuchen Sie es erneut.', retry: 'Erneut laden', open_project: 'News Deframer auf GitHub', ok: 'OK',
      },
    },
  },
} as const;
