...
const resources = {
  ...
  de: {
    translation: {
      ...
      trends: {
        cloud: 'Tag Cloud', compare_view: 'Vergleich', lifecycle: 'Verlauf', context: 'Kontext', articles: 'Artikel', search: 'Suche', no_data: 'Keine Trendthemen für diesen Zeitraum gefunden.', rank: 'Rang', trend: 'Trend', vol: 'Vol', rating_caption: 'Bewertung', date_caption: 'Datum', author_caption: 'Autor', article_caption: 'Artikel', time_ranges: { last_24h: '24h', last_7d: '7 T.', last_30d: '30 T.', last_90d: '90 T.', last_365d: '365 T.' },
      },
      article: {
        back: 'Zurück',
        no_title: 'Kein Titel',
