...
It is implemented as dual use. It can act as an **RSS feed analysis workflow** or as a **browser extension** to provide a "framing score" and context, helping users decide if an article is worth reading or if it is heavily biased.

Here are examples with screenshots for our [browser extension](https://deframer.github.io/screenshots/) and [RSS feed](https://deframer.github.io/screenshots/rss-feed/) for very quick use on your mobile phone.
